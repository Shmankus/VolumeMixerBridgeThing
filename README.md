...
1. Push this repo to `https://github.com/Shmank/volumeMixerBridgeThing`.
2. In **Settings > Pages**, set the source to **Deploy from a branch**, branch `gh-pages`, folder `/ (root)`.

The catalog is published to `https://shmank.github.io/volumeMixerBridgeThing/catalog.v1.json`, which can be submitted to <bridgething.com/apps>
